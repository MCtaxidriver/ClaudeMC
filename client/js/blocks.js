...
export const BLOCK_INFO = [
  ...
  def('Eichenlaub', { tiles: same(T.LEAVES), hardness: 0.35, drop: null }),
  ...
  def('Birkenlaub', { tiles: same(T.BIRCH_LEAVES), hardness: 0.35, drop: null }),
  def('Schwarzeichenstamm', { tiles: { top: T.DARK_TOP, bottom: T.DARK_TOP, side: T.DARK_SIDE }, hardness: 3, tool: 'axe' }),
  def('Schwarzeichenlaub', { tiles: same(T.DARK_LEAVES), hardness: 0.35, drop: null }),
  def('Akazienstamm', { tiles: { top: T.ACACIA_TOP, bottom: T.ACACIA_TOP, side: T.ACACIA_SIDE }, hardness: 3, tool: 'axe' }),
  /* 45 */ def('Akazienlaub', { tiles: same(T.ACACIA_LEAVES), hardness: 0.35, drop: null }),
